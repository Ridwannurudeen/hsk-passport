...
import { apiSumsubData } from "@/lib/api";
...
export default function UserPage() {
  ...
  const [tab, setTab] = useState<"identity" | "verified" | "credentials">(
    "identity",
  );
  ...
  useEffect(() => {
    ...
    const eth = window.ethereum as {
      on?: (e: string, h: (a: string[]) => void) => void;
    };
    ...
    <div className="max-w-3xl mx-auto px-4 py-12">
      ...
      {!identity ? (
        <div className="bg-gray-900 border border-gray-800 rounded-xl p-8 text-center">
          <h2 className="text-xl font-semibold mb-3">No Identity Found</h2>
          ...
          <div className="flex gap-1 border-b border-gray-800">
            {[
              ...
              >
                {t.label}
                {t.badge && (
                  <span className="ml-1.5 text-green-400">{t.badge}</span>
                )}
              </button>
            ))}
          </div>
            ...
            (verifiedData?.verified ? (
              <div className="bg-gradient-to-br from-green-950/30 to-gray-900 border border-green-800/50 rounded-xl p-6">
                <div className="flex items-center justify-between mb-2">
                  <div>
                    ...
                    <p className="text-xs text-gray-500">
                      Verified via Sumsub — same provider used by HashKey
                      Exchange
                    </p>
                  </div>
                ...
                <div className="mt-4 text-xs text-gray-400 bg-gray-900/50 border border-gray-800 rounded-lg p-3">
                  ...
                  Your identity documents stay with Sumsub — HSK Passport never
                  receives or stores them. Your on-chain credential is only a
                  cryptographic commitment and reveals nothing about who you
                  are.
                </div>
              ...
              <div className="bg-gray-900 border border-gray-800 rounded-xl p-8 text-center">
                ...
                <p className="text-sm text-gray-400 mb-4">
                  Complete KYC via Sumsub to see your verification status here.
                </p>
                <a
                  href="/kyc"
                  className="inline-block px-4 py-2 bg-purple-600 hover:bg-purple-500 text-white text-sm rounded-lg"
                >
                  Start Verification
                </a>
              </div>
