    ...
    <div className="max-w-4xl mx-auto px-4 py-12">
      <div className="mb-10">
        ...
        <p className="text-lg text-gray-400 max-w-2xl">
          Add privacy-preserving ZK credential verification to your dApp in
          under 10 minutes.
        </p>
      </div>
...
contract MyDApp {
    ...
    function restrictedAction(
        ...
        <p className="text-sm text-gray-400 mt-3">
          <strong className="text-white">Security tip:</strong> Always bind
          proofs to <code className="text-purple-300">msg.sender</code> to
          prevent front-running attacks. The{" "}
          <code className="text-purple-300">message</code> field of the proof
          must equal the caller&apos;s address cast to uint256.
        </p>
      </section>
      ...
      <section className="mb-10">
        ...
        <p className="text-sm text-gray-400 mb-3">
          Install the SDK (or copy from{" "}
          <a
            href="https://github.com/Ridwannurudeen/hsk-passport/tree/master/sdk"
            target="_blank"
        ...
        <div className="bg-gray-900 border border-gray-800 rounded-xl p-4 mb-4">
          <pre className="text-sm font-mono text-gray-300">
            npm install hsk-passport-sdk ethers @semaphore-protocol/identity
            @semaphore-protocol/group @semaphore-protocol/proof
          </pre>
        </div>
        <div className="bg-gray-900 border border-gray-800 rounded-xl p-5 overflow-x-auto">
...
const valid = await passport.verifyProof(25, proof);`}</pre>
        </div>
      </section>
      ...
      <section className="mb-10">
        ...
        <p className="text-sm text-gray-400 mb-4">
          Query group members and KYC state without running an Ethereum node.
          Base URL:{" "}
          <code className="text-purple-300">
            https://hskpassport.gudman.xyz/api
          </code>
        </p>
          ...
          {[
            {
              ...
              desc: "Active identity commitments in a credential group (revocation-aware)",
            },
            {
              method: "GET",
              path: "/api/groups/:groupId/stats",
              desc: "Group size and issuance/revocation counts",
            },
            {
              method: "GET",
              path: "/api/credentials/:commitment",
              desc: "Groups a specific identity belongs to",
            },
            {
              method: "GET",
              path: "/api/stats/global",
              desc: "Protocol-wide stats: active credentials, groups, submissions",
            },
            {
              method: "POST",
              path: "/api/kyc/submit",
              desc: "Submit a KYC request for issuer review",
            },
            {
              method: "GET",
              path: "/api/kyc/queue?status=pending",
              desc: "Issuer queue of pending/approved/rejected requests",
            },
            {
              method: "POST",
              path: "/api/kyc/review",
              desc: "Issuer action — approve (record tx) or reject",
            },
          ].map((endpoint) => (
            <div
              key={endpoint.path}
            ...
            >
              <span
                className={`shrink-0 px-2 py-0.5 text-xs font-mono rounded ${
                  endpoint.method === "GET"
        ...
        <div className="bg-gray-900 border border-gray-800 rounded-xl p-5">
          ...
          <dl className="space-y-2 text-sm">
            {[
              {
                label: "HSKPassport",
                address: "0x7d2E692A08f2fb0724238396e0436106b4FbD792",
              },
              {
                label: "CredentialRegistry",
                address: "0x20265dAe4711B3CeF88D7078bf1290f815279De1",
              },
              {
                label: "Semaphore",
                address: "0xd09e8Aec6B6A36588E7A105f606A9fe9a134CFE9",
              },
              {
                label: "Timelock (48h)",
                address: "0xb07Bc78559CbDe44c047b1dC3028d13c4f863D8A",
              },
              {
                label: "DemoIssuer",
                address: "0xBf7d566B8077A098F6844fb6b827D2A4118C88C3",
              },
              {
                label: "HashKeyDIDBridge",
                address: "0xF072D06adcA2B6d5941bde6cc87f41feC5F5Ea7a",
              },
              {
                label: "HashKeyKYCImporter",
                address: "0x5431ae6D2f5c3Ad3373B7B4DD4066000D681f5B8",
              },
              {
                label: "GatedRWA (hSILVER)",
                address: "0xb6955cb3e442c4222fFc3b92c322851109d0b9c9",
              },
              {
                label: "KYCGatedAirdrop (hPILOT)",
                address: "0x71c96016CBCAeE7B2Edc8b40Fec45de1d16Fb4b8",
              },
              {
                label: "KYCGatedLending",
                address: "0x37179886986bd35a4d580f157f55f249c43A0BFD",
              },
              {
                label: "JurisdictionGatedPool",
                address: "0x305f5F0b44d541785305DaDb372f118A9284Ce4D",
              },
              {
                label: "FreshnessRegistry (v6)",
                address: "0xd251ecAD1a863299BAD2E25B93377B736a753938",
              },
              {
                label: "FreshnessVerifier (v6)",
                address: "0x59A03fF053464150b066e78d22AEc2F69D081394",
              },
              {
                label: "HSKPassportFreshness (v6)",
                address: "0xFF790dE1537a84220cD12ef648650034D4725fBb",
              },
            ].map((c) => (
              <div
                key={c.address}
              ...
              >
                ...
                <dd>
                  <a
                    href={`https://hashkey-testnet.blockscout.com/address/${c.address}`}
                    target="_blank"
                    rel="noopener noreferrer"
          ...
          <div className="mt-6 pt-5 border-t border-gray-800">
            ...
            <dl className="space-y-2 text-sm">
              <div className="flex items-center justify-between py-1">
                ...
                <dd>
                  <a
                    href="https://explorer.hsk.xyz/address/0xf109cBe3D8d54D77C85ECF1367Cfcd6f075868e9"
                    target="_blank"
                    rel="noopener noreferrer"
  ...
  Verify KYC & Mint
      ...
      <section className="mb-10">
        ...
        <div className="grid md:grid-cols-3 gap-3">
          <Link
            href="/ecosystem"
            className="block bg-gray-900 border border-gray-800 hover:border-purple-800 rounded-xl p-5 transition-colors"
          >
            <div className="text-sm font-semibold text-purple-400 mb-1">
              RWA Minting
            </div>
            <div className="text-xs text-gray-500">
              KYC-gated ERC-20 mint with nullifier tracking
            </div>
          </Link>
          <Link
            href="/ecosystem"
          ...
          >
            ...
            <div className="text-xs text-gray-500">
              Per-round nullifiers prevent double-claims
            </div>
          </Link>
          <Link
            href="/ecosystem"
          ...
          >
            ...
            <div className="text-xs text-gray-500">
              Tiered access based on credential group
            </div>
          </Link>
        </div>
      </section>
